  ...
  <div class="main-panel">
        <div class="content-wrapper">
              <div class="container-fluid">
                ...
                <form method="Post" action="{{route('adminPostEditColoris',$finition->id)}}">
                    @csrf
            ...
            <option disabled selected required>Select Color</option>
                      ...
                      <div class="form-group" >
                        ...
                        <input type="text" required="" value="{{$finition->name}}"  class="form-control" id="finitionName" name="finitionName" aria-describedby="emailHelp" placeholder="Enter Finition Name">
