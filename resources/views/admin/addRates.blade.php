              ...
              <div class="container-fluid">
                ...
                <div class="col-lg-1">
                 ...
                 <div class="col-lg-10" >
                  ...
                  <form method="Post" action="{{route('post-rates')}}">
                    @csrf
            ...
            <select id="coloris" name="coloris" class="optiseldev form-control">
         		...
         		<option disabled selected required>Select Color</option>
                      ...
                      <div class="form-group" >
                        ...
                        <select class="optiseldev form-control" name="finition" id="finition">
                      ...
                      <div class="form-group" >
                        ...
                        <input type="number" required="" class="form-control" id="finitionRate" name="Rate" aria-describedby="emailHelp" placeholder="Enter Rate">
