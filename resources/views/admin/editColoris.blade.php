        ...
        <div class="content-wrapper">
              <div class="container-fluid">
                ...
                <div class="col-lg-1">
                 ...
                 <div class="col-lg-10" >
                  ...
                  <form method="Post" action="{{route('adminEditColoris',$coloris->id)}}" enctype="multipart/form-data">
                    @csrf
            ...
            <option disabled selected required>Select Color</option>
                      ...
                      <div class="form-group" >
                        ...
                        <input type="text" required="" class="form-control" value="{{$coloris->name}}" id="colorisName" name="colorisName" aria-describedby="emailHelp" placeholder="Enter Coloris Name">
                      ...
                      <div class="form-group" >
                        <label for="Picture">Picture :</label>
                            <input type="file" required="" id="Picture" class="form-control"  value="{{asset('images/stones/'.$coloris->thumbnail)}}" name="thumbnail" placeholder='Enter Option Picture' required=""> 
                      </div>     
