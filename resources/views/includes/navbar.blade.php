        <nav class="navbar navbar-default navbar-fixed-top fadeInDown" data-wow-delay="0.5s">
            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand smoothie logo logo-light" href="index.html"><img src="{{asset('Kompleet/assets/img/logo.png')}}" alt="logo"></a>
                    <a class="navbar-brand smoothie logo logo-dark" href="index.html"><img src="{{asset('Kompleet/assets/img/logo_reverse.png')}}" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li >
                            <a href="{{route('devisGratuit')}}" class="btn btn-warning" data-hover="dropdown" style="margin-top:20px;padding: 2px;" >DEVIS GRATUIT </a>
                        </li>
                        <li >
                            <a href="{{route('adminDashboard')}}" class="btn btn-success" data-hover="dropdown" style="margin-top:20px;padding: 2px;" >Login</a>
                        </li>
