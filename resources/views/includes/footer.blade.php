                            ...
                            <div class="col-md-4">
                                <div class="widget">
                                    ...
                                    <div>
                                        <div class="media">
                                            <div class="pull-left">
                                                <img class="widget-img" src="{{asset('Kompleet/assets/img/widget/widget1.jpg')}}" alt="">
                                            </div>
                                        ...
                                        <div class="media">
                                            <div class="pull-left">
                                                <img class="widget-img" src="{{asset('Kompleet/assets/img/widget/widget2.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
            ...
            <div class="viewport">
                <div class="widget mb50">
                    ...
                    <div>
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="{{asset('Kompleet/assets/img/widget/widget3.jpg')}}" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="{{asset('Kompleet/assets/img/widget/widget4.jpg')}}" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="{{asset('Kompleet/assets/img/widget/widget5.jpg')}}" alt="">
                            </div>
                            <div class="media-body">
    ...
    <script src="{{asset('Kompleet/assets/js/jquery.js')}}"></script>
    <script src="{{asset('Kompleet/assets/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('Kompleet/assets/js/plugins.js')}}"></script>
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
    <script src="{{asset('Kompleet/assets/js/init.js')}}"></script>
    ...
    $(document).ready(function() {
        ...
        jQuery('#headerwrap').backstretch([
            "{{asset('Kompleet/assets/img/bg/bg1.jpg')}}",
            "{{asset('Kompleet/assets/img/bg/bg2.jpg')}}",
            "{{asset('Kompleet/assets/img/bg/bg3.jpg')}}"
        ], {
            duration: 8000,
            fade: 500
        });
